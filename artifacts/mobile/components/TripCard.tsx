...
export default function TripCard({ trip, onPress, onBook, onViewCarrier }: TripCardProps) {
  ...
  return (
    ...
    >
      <View style={styles.card}>
        ...
        {/* Header — tapping avatar/name area views carrier profile */}
        <TouchableOpacity
          onPress={() => {
            Haptics.selectionAsync();
            if (onViewCarrier) onViewCarrier();
...
const styles = StyleSheet.create({
  ...
  headerInfo: { flex: 1 },
  travelerName: { color: "#FFFFFF", fontSize: 14, fontFamily: "Inter_600SemiBold" },
  ...
  routeRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingBottom: 12 },
  routeEndpoint: { flexDirection: "row", alignItems: "center", gap: 6 },
  ...
  bookGradient: { paddingVertical: 7, paddingHorizontal: 12 },
  bookText: { color: "#fff", fontSize: 11, fontFamily: "Inter_600SemiBold" },
});
